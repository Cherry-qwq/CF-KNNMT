...
--adam-eps 1e-8 --clip-norm 1.0 \
--lr 3e-4 --lr-scheduler reduce_lr_on_plateau --min-lr 3e-5 --lr-patience 5 --lr-shrink 0.5 --patience 30 \
...
--tensorboard-logdir $PROJECT_PATH/save-models/LRKNNMT/log \
--batch-size 4 \
--update-freq 8 \
--user-dir $PROJECT_PATH/knnbox/models \
--arch less_retrieve_knn_mt@transformer_wmt19_de_en \
--whether_retrieve_selector_path $PROJECT_PATH/save-models/LRKNNMT/selector.pt \
